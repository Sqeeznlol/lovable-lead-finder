...
-- =====================================================================
-- Erzeugt aus supabase/migrations/, in zeitlicher Reihenfolge.
-- Auf einer leeren Supabase-Instanz im SQL-Editor ausführen.
--
-- Getestet gegen eine frische Postgres-16-Datenbank: läuft ohne Fehler
-- durch und legt Tabellen, Policies, die Potenzial-Rechnung und den
-- Trigger an, der jedes neue Objekt automatisch durchrechnet.
--
-- Hinweis: Der Block zu pg_cron (Tages-Digest) kann fehlschlagen, wenn
-- die Extension im Projekt nicht aktiviert ist. Das ist unkritisch --
-- alles Übrige läuft unabhängig davon.
-- =====================================================================
